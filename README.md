...
We used **Django** for **Python** to create Back-End for this project, **HTML, CSS, Leaflet.JS** and **Bootstrap** were used for Front-End alognside some web mapping functionalities. Data is being stored in a **PostgreSQL** database in a **Docker** container.
